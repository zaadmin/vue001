					...
					<div class="mui-card-content-inner">
                        ...
                        <div class="info">
                            ...
                            <p>
                                ...
                                <!-- 从购物车中获取商品的数量 -->
                                <!-- 先创建一个空对象，然后循环购物车中所有商品的数据，把 当前循环这条商品的 ID，作为对象的属性名，
                                count值作为对象的属性值，这样，当把所有的商品循环一遍，就会的到一个对象： {88： 2， 89： 3,90:1} -->
...
<script>
    ...
    export default {
        ...
        methods: {
            getGoodsList() {
                //获取到 store 中所有商品的ID，然后拼接出一个用 逗号 分隔的 字符串
                var idArr = [];
                ...
                remove(id, index){
                    // 点击删除，把商品从 store中根据传递的ID删除，同时，把当前组件中的goodslist 中，对应要删除的那个商品，
                    // 使用index 来删除
                    this.goodslist.splice(index, 1);
                    this.$store.commit('removeFromCar', id); 
                },
                selectedChanged(id, val){
                    //每当点击开关，把最新的 开关状态，同步到store 中
